---
title: "DTS Library Universal Report Template - Sample Blueprint"
date: "2025-12-03"
...
<OpeningFrame 
  videoId="dQw4w9WgXcQ" 
  title="DTS Library Blueprint Introduction"
/>
...
<Accordion>
  ...
  <AccordionItem title="1. Universal Structure">
    ...
    DTS Library 리포트 엔진은 다음과 같은 컴포넌트 기반 아키텍처를 따릅니다:
...
```mermaid
mindmap
  root((DTS Library Report Engine))
